...
const StateletContext = /*#__PURE__*/createContext();
const StateletProvider = ({
  children,
  value
}) => {
  const {
  ...
  return /*#__PURE__*/React.createElement(StateletContext.Provider, {
    value: store
  }, children);
};
...
export { StateletProvider, useCreateStateletAction, useStatelet, useStateletDispatch };
